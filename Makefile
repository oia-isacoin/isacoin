#############################################################################
# Makefile for building: Isacoin-Qt.app/Contents/MacOS/Isacoin-Qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: Tue Oct 23 06:22:05 2018
# Project:  Isacoin-qt.pro
# Template: app
# Command: /usr/local/Cellar/qt@4/4.8.7_5/bin/qmake RELEASE=1 USE_UPNP=- USE_QRCODE=1 -o Makefile Isacoin-qt.pro
#############################################################################
...
CC            = clang
CXX           = llvm-g++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_QRCODE -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DMAC_OSX -DMSG_NOSIGNAL=0 -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
CFLAGS        = -pipe -mmacosx-version-min=10.7 -mmacosx-version-min=10.7 -arch i386 -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX10.7.sdk -O2 -arch x86_64 -pthread -Wall -W $(DEFINES)
CXXFLAGS      = -pipe -stdlib=libc++ -mmacosx-version-min=10.7 -mmacosx-version-min=10.7 -arch i386 -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX10.7.sdk -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2 -arch x86_64 -pthread -fdiagnostics-show-option -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector $(DEFINES)
INCPATH       = -I/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/unsupported/macx-clang -I/usr/local/Cellar/qt@4/4.8.7_5/lib/QtCore.framework/Versions/4/Headers -I/usr/local/Cellar/qt@4/4.8.7_5/lib/QtCore.framework/Versions/4/Headers -I/usr/local/Cellar/qt@4/4.8.7_5/lib/QtNetwork.framework/Versions/4/Headers -I/usr/local/Cellar/qt@4/4.8.7_5/lib/QtNetwork.framework/Versions/4/Headers -I/usr/local/Cellar/qt@4/4.8.7_5/lib/QtGui.framework/Versions/4/Headers -I/usr/local/Cellar/qt@4/4.8.7_5/lib/QtGui.framework/Versions/4/Headers -I/usr/local/include -Isrc -Isrc/json -Isrc/qt -Isrc/leveldb/include -Isrc/leveldb/helpers -I/usr/local/opt/boost/include -I/usr/local/opt/berkeley-db@4/include -I/usr/local/opt/openssl/include -I/usr/local/opt/qrencode/include -Ibuild -Ibuild -F/usr/local/lib
LINK          = llvm-g++
LFLAGS        = -headerpad_max_install_names -stdlib=libc++ -mmacosx-version-min=10.7 -fstack-protector-all -arch x86_64 -pthread
LIBS          = $(SUBLIBS) -F/usr/local/lib -L/usr/local/lib -lqrencode /Users/omisaal/isacoin/src/leveldb/libleveldb.a /Users/omisaal/isacoin/src/leveldb/libmemenv.a -framework Foundation -framework ApplicationServices -framework AppKit -framework CoreServices -L/usr/local/opt/boost/lib -L/usr/local/opt/berkeley-db@4/lib -L/usr/local/opt/openssl/lib -L/usr/local/opt/qrencode/lib -lssl -lcrypto -ldb_cxx-4.8 -lboost_system-mt -lboost_filesystem-mt -lboost_program_options-mt -lboost_thread-mt -lboost_chrono-mt -framework QtGui -L/usr/local/opt/openssl/lib -L/usr/local/Cellar/qt@4/4.8.7_5/lib -F/usr/local/Cellar/qt@4/4.8.7_5/lib -framework QtCore -framework QtNetwork 
AR            = ar cq
RANLIB        = ranlib -s
QMAKE         = /usr/local/Cellar/qt@4/4.8.7_5/bin/qmake
TAR           = tar -cf
COMPRESS      = gzip -9f
COPY          = cp -f
SED           = sed
...
DIST          = /usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/common/unix.conf \
		...
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/common/clang.conf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/qconfig.pri \
		/usr/local/Cellar/qt-webkit@2.3/2.3.4_1/etc/qt4/mkspecs/modules/qt_webkit.pri \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/qt_functions.prf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/qt_config.prf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/exclusive_builds.prf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/default_pre.prf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/mac/default_pre.prf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/release.prf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/default_post.prf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/mac/default_post.prf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/mac/x86_64.prf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/mac/objective_c.prf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/static.prf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/unix/thread.prf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/warn_on.prf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/qt.prf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/moc.prf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/mac/rez.prf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/mac/sdk.prf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/resources.prf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/uic.prf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/yacc.prf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/features/lex.prf \
		Isacoin-qt.pro
QMAKE_TARGET  = Isacoin-Qt
DESTDIR       = 
TARGET        = Isacoin-Qt.app/Contents/MacOS/Isacoin-Qt
...
QMAKE_COMP_QMAKE_OBJECTIVE_CFLAGS = -pipe \
		...
		i386 \
		-isysroot \
		/Library/Developer/CommandLineTools/SDKs/MacOSX10.7.sdk \
		-O2 \
		-arch \
		x86_64 \
		-Wall \
...
all: Makefile Isacoin-Qt.app/Contents/PkgInfo Isacoin-Qt.app/Contents/Resources/empty.lproj Isacoin-Qt.app/Contents/Info.plist Isacoin-Qt.app/Contents/Resources/isacoin.icns $(TARGET)

$(TARGET): /Users/omisaal/isacoin/src/leveldb/libleveldb.a /Users/omisaal/isacoin/build/build.h build/ui_sendcoinsdialog.h build/ui_coincontroldialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h build/ui_qrcodedialog.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) Isacoin-Qt.app/Contents/MacOS/ || $(MKDIR) Isacoin-Qt.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Isacoin-qt.pro  /usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/unsupported/macx-clang/qmake.conf /usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt@4/4.8.7_5/etc/qt4/mkspecs/common/clang.conf \
		...
		/usr/local/lib/QtNetwork.framework/QtNetwork.prl
	$(QMAKE) RELEASE=1 USE_UPNP=- USE_QRCODE=1 -o Makefile Isacoin-qt.pro
...
Isacoin-Qt.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) Isacoin-Qt.app/Contents || $(MKDIR) Isacoin-Qt.app/Contents 
	@$(DEL_FILE) Isacoin-Qt.app/Contents/PkgInfo
	@echo "APPL????" >Isacoin-Qt.app/Contents/PkgInfo
Isacoin-Qt.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) Isacoin-Qt.app/Contents/Resources || $(MKDIR) Isacoin-Qt.app/Contents/Resources 
	@touch Isacoin-Qt.app/Contents/Resources/empty.lproj
	
Isacoin-Qt.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) Isacoin-Qt.app/Contents || $(MKDIR) Isacoin-Qt.app/Contents 
	@$(DEL_FILE) Isacoin-Qt.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,0.8,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,isacoin.icns,g" -e "s,@EXECUTABLE@,Isacoin-Qt,g" -e "s,@TYPEINFO@,????,g" share/qt/Info.plist >Isacoin-Qt.app/Contents/Info.plist
Isacoin-Qt.app/Contents/Resources/isacoin.icns: src/qt/res/icons/isacoin.icns
	@$(CHK_DIR_EXISTS) Isacoin-Qt.app/Contents/Resources/ || $(MKDIR) Isacoin-Qt.app/Contents/Resources/ 
	@$(DEL_FILE) Isacoin-Qt.app/Contents/Resources/isacoin.icns
	@$(COPY_FILE) src/qt/res/icons/isacoin.icns Isacoin-Qt.app/Contents/Resources/isacoin.icns
dist: 
	@$(CHK_DIR_EXISTS) build/Isacoin-Qt0.8.7.4 || $(MKDIR) build/Isacoin-Qt0.8.7.4 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Isacoin-Qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/Isacoin-Qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm src/qt/macnotificationhandler.mm build/Isacoin-Qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/coincontroldialog.h src/qt/coincontroltreewidget.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/coincontrol.h src/compat.h src/sync.h src/util.h src/hash.h src/uint256.h src/serialize.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/bloom.h src/mruset.h src/checkqueue.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/qt/walletview.h src/qt/walletstack.h src/qt/walletframe.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/paymentserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/scrypt.h src/version.h src/netbase.h src/clientversion.h src/txdb.h src/leveldb.h src/threadsafety.h src/limitedmap.h src/qt/macnotificationhandler.h src/qt/splashscreen.h src/qt/qrcodedialog.h src/qt/macdockiconhandler.h src/qt/macnotificationhandler.h build/Isacoin-Qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/Isacoin-Qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/coincontroldialog.cpp src/qt/coincontroltreewidget.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/hash.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/bloom.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/qt/walletview.cpp src/qt/walletstack.cpp src/qt/walletframe.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/paymentserver.cpp src/qt/rpcconsole.cpp src/scrypt.cpp src/noui.cpp src/leveldb.cpp src/txdb.cpp src/qt/splashscreen.cpp src/qt/qrcodedialog.cpp build/Isacoin-Qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm src/qt/macnotificationhandler.mm build/Isacoin-Qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/coincontroldialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui src/qt/forms/qrcodedialog.ui build/Isacoin-Qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/Isacoin-Qt0.8.7.4/ && (cd `dirname build/Isacoin-Qt0.8.7.4` && $(TAR) Isacoin-Qt0.8.7.4.tar Isacoin-Qt0.8.7.4 && $(COMPRESS) Isacoin-Qt0.8.7.4.tar) && $(MOVE) `dirname build/Isacoin-Qt0.8.7.4`/Isacoin-Qt0.8.7.4.tar.gz . && $(DEL_FILE) -r build/Isacoin-Qt0.8.7.4


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /Users/omisaal/isacoin/src/leveldb/libleveldb.a; cd /Users/omisaal/isacoin/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
distclean: clean
	-$(DEL_FILE) -r Isacoin-Qt.app
	-$(DEL_FILE) Makefile


/Users/omisaal/isacoin/src/leveldb/libleveldb.a: FORCE
	cd /Users/omisaal/isacoin/src/leveldb && CC=clang CXX=llvm-g++ $(MAKE) OPT="-pipe -stdlib=libc++ -mmacosx-version-min=10.7 -mmacosx-version-min=10.7 -arch x86_64 -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX10.7.sdk -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/Users/omisaal/isacoin/build/build.h: FORCE
	cd /Users/omisaal/isacoin; /bin/sh share/genbuild.sh /Users/omisaal/isacoin/build/build.h
...
src/qt/locale/bitcoin_af_ZA.qm: src/qt/locale/bitcoin_af_ZA.ts
	/usr/local/bin/lrelease src/qt/locale/bitcoin_af_ZA.ts -qm src/qt/locale/bitcoin_af_ZA.qm

src/qt/locale/bitcoin_ar.qm: src/qt/locale/bitcoin_ar.ts
	/usr/local/bin/lrelease src/qt/locale/bitcoin_ar.ts -qm src/qt/locale/bitcoin_ar.qm
...
src/qt/locale/bitcoin_bs.qm: src/qt/locale/bitcoin_bs.ts
	/usr/local/bin/lrelease src/qt/locale/bitcoin_bs.ts -qm src/qt/locale/bitcoin_bs.qm

src/qt/locale/bitcoin_ca.qm: src/qt/locale/bitcoin_ca.ts
	/usr/local/bin/lrelease src/qt/locale/bitcoin_ca.ts -qm src/qt/locale/bitcoin_ca.qm
...
src/qt/locale/bitcoin_cy.qm: src/qt/locale/bitcoin_cy.ts
	/usr/local/bin/lrelease src/qt/locale/bitcoin_cy.ts -qm src/qt/locale/bitcoin_cy.qm
...
src/qt/locale/bitcoin_eo.qm: src/qt/locale/bitcoin_eo.ts
	/usr/local/bin/lrelease src/qt/locale/bitcoin_eo.ts -qm src/qt/locale/bitcoin_eo.qm
...
src/qt/locale/bitcoin_gu_IN.qm: src/qt/locale/bitcoin_gu_IN.ts
	/usr/local/bin/lrelease src/qt/locale/bitcoin_gu_IN.ts -qm src/qt/locale/bitcoin_gu_IN.qm
...
src/qt/locale/bitcoin_hi_IN.qm: src/qt/locale/bitcoin_hi_IN.ts
	/usr/local/bin/lrelease src/qt/locale/bitcoin_hi_IN.ts -qm src/qt/locale/bitcoin_hi_IN.qm
...
src/qt/locale/bitcoin_ja.qm: src/qt/locale/bitcoin_ja.ts
	/usr/local/bin/lrelease src/qt/locale/bitcoin_ja.ts -qm src/qt/locale/bitcoin_ja.qm

src/qt/locale/bitcoin_la.qm: src/qt/locale/bitcoin_la.ts
	/usr/local/bin/lrelease src/qt/locale/bitcoin_la.ts -qm src/qt/locale/bitcoin_la.qm
...
src/qt/locale/bitcoin_lv_LV.qm: src/qt/locale/bitcoin_lv_LV.ts
	/usr/local/bin/lrelease src/qt/locale/bitcoin_lv_LV.ts -qm src/qt/locale/bitcoin_lv_LV.qm
...
src/qt/locale/bitcoin_th_TH.qm: src/qt/locale/bitcoin_th_TH.ts
	/usr/local/bin/lrelease src/qt/locale/bitcoin_th_TH.ts -qm src/qt/locale/bitcoin_th_TH.qm
...
build/moc_coincontroldialog.cpp: src/qt/coincontroldialog.h
	/usr/local/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/coincontroldialog.h -o build/moc_coincontroldialog.cpp

build/moc_coincontroltreewidget.cpp: src/qt/coincontroltreewidget.h
	/usr/local/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/coincontroltreewidget.h -o build/moc_coincontroltreewidget.cpp
...
build/moc_walletview.cpp: src/qt/walletview.h
	/usr/local/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/walletview.h -o build/moc_walletview.cpp

build/moc_walletstack.cpp: src/qt/walletstack.h
	/usr/local/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/walletstack.h -o build/moc_walletstack.cpp

build/moc_walletframe.cpp: src/qt/walletframe.h
	/usr/local/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/walletframe.h -o build/moc_walletframe.cpp
...
build/moc_bitcoinunits.cpp: src/qt/bitcoinunits.h
	/usr/local/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/bitcoinunits.h -o build/moc_bitcoinunits.cpp
...
build/moc_paymentserver.cpp: src/qt/paymentserver.h
	/usr/local/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/paymentserver.h -o build/moc_paymentserver.cpp
...
build/moc_macnotificationhandler.cpp: src/qt/macnotificationhandler.h
	/usr/local/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/macnotificationhandler.h -o build/moc_macnotificationhandler.cpp

build/moc_splashscreen.cpp: src/qt/splashscreen.h
	/usr/local/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/splashscreen.h -o build/moc_splashscreen.cpp
...
build/ui_coincontroldialog.h: src/qt/forms/coincontroldialog.ui \
	...
	/usr/local/bin/uic src/qt/forms/coincontroldialog.ui -o build/ui_coincontroldialog.h
