...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Isacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"omisaal.com", "isaseed.omisaal.com"},
    {NULL, NULL}
};
...
unsigned int pnSeed[] =
{
    0x7fe25f17, 0x99e25f17, 0xa0e25f17, 0x93e95f17
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Isacoin is probably already running."), addrBind.ToString().c_str());
        else
